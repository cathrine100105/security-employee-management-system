  ...
  return (
    ...
    >
      ...
      <div className="rounded-[34px] bg-gradient-to-br from-indigo-300/60 via-violet-200/60 to-white p-[1px]">
        <div className="relative overflow-hidden rounded-[32px] border border-white/60 bg-white/90 p-8 shadow-[0_25px_60px_rgba(15,23,42,0.15)] backdrop-blur-xl">
          ...
          <div className="relative z-10">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-slate-500 leading-7">{subtitle}</p>
            </div>
